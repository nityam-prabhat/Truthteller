...
loaded_model = keras.models.load_model('./deepfakeModel.keras')
...
def predict_video(video_path, frame_skip=30):
    ...
    print(f'The confidence score is: {deepfake_ratio}')
    return 1-deepfake_ratio
    # Return "Deepfake" if the ratio is greater than 0.5, otherwise "Original"
    # return "Deepfake" if deepfake_ratio > 0.5 else "Original"
